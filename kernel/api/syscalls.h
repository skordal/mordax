...
#define MORDAX_SYSCALL_DT_GET_PROPERTY_ARRAY32	22
#define MORDAX_SYSCALL_DT_GET_PROPERTY_STRING	23
#define MORDAX_SYSCALL_DT_GET_PROPERTY_PHANDLE	24

// Resource syscalls:
#define MORDAX_SYSCALL_RESOURCE_DESTROY	25
