...
// Lock syscalls:
#define MORDAX_SYSCALL_LOCK_CREATE	16
#define MORDAX_SYSCALL_LOCK_AQUIRE	17
#define MORDAX_SYSCALL_LOCK_RELEASE	18

// Resource syscalls:
#define MORDAX_SYSCALL_RESOURCE_DESTROY	19
